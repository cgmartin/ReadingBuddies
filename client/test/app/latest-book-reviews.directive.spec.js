...
describe('Reader Module', function () {
    ...
    describe('latestBookReviews Directive', function () {
        it('should display no reviews when empty', inject(function ($q) {
            ...
            chai.expect(parentDiv.find('h3').html()).to.eql('<a ng-href="website" class="ng-binding" href="website">test</a>');
        ...
        it('should display reviews that exist', inject(function ($q) {
            ...
            chai.expect(parentDiv.find('h3').html()).to.eql('<a ng-href="website" class="ng-binding" href="website">reviewsTest</a>');
            chai.expect(angular.element(parentDiv[0].querySelector('.reviews'))
